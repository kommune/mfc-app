...
User.create!(name: "User3", username: "user3", password: "123123", postal_code: "650175", email: "user3@montfortcare.org.sg", birth_date: Date.new(1958, 6, 22), role: 1)
User.create!(name: "User4", username: "user4", password: "123123", postal_code: "650175", email: "user4@montfortcare.org.sg", birth_date: Date.new(1978, 6, 22), role: 1)
puts "2 agency users created"
